...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
        ...
        // hboxMem.add(Box.createHorizontalStrut(70),BorderLayout.CENTER);
        ...
        // hboxMem.add(Box.createHorizontalStrut(30),BorderLayout.CENTER);
        ...
        hboxVariables.add(Box.createHorizontalGlue());
        //hboxVariables.add(Box.createHorizontalStrut(80),JLabel.LEFT);
        hboxVariables.add(labelForY);
        //  hboxVariables.add(Box.createHorizontalStrut(10),BorderLayout.CENTER);
        hboxVariables.add(textFieldY);
        hboxVariables.add(Box.createHorizontalGlue());
        // hboxVariables.add(Box.createHorizontalStrut(70),JLabel.CENTER);
        hboxVariables.add(labelForZ);
        //  hboxVariables.add(Box.createHorizontalStrut(100),BorderLayout.CENTER);
        hboxVariables.add(textFieldZ);
        // hboxVariables.add(Box.createHorizontalStrut(80),JLabel.RIGHT);
